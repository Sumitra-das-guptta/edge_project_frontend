    ...
    return (
        <div className='my-[14vh] min-h-[64vh]'>
            ...
            <div
                ...
                <br /><br />
                <div className='font-bold text-lg text-slate-400'>Vision</div>
                ...
                <br /><br />
                <div className='font-bold text-lg text-slate-400'>Mission</div>
            ...
            <div className='text-sm font-medium p-2.5 bg-gradient-to-r from-gray-400 to-gray-900 text-transparent bg-clip-text text-left'
                ...
                <div className='text-slate-500 ml-[10%]'>
            ...
            <div className='text-sm font-medium p-2.5 bg-gradient-to-r from-gray-400 to-gray-900 text-transparent bg-clip-text text-left'
                ...
                <div className='pl-3'>1. Basic Office Management </div>
                <div className='pl-3'>2. Basic Network Administration & Computer Hardware </div>
                <div className='pl-3'>3. Basic Web Development </div>
                <div className='font-semibold text-lg text-slate-500'>Intermediate Level Training:</div>
