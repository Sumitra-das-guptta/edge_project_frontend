...
const RegistrationFormForFoundational = () => {
        ...
        onSubmit: (values) => {
            if (state?.email && state?.course && state?.organizerDeptOrInstituteOrCenter) {
                let dataForSubmit = {
                    ...
                    "levelOfEducation": levelOfEducation?.filter(eachLevel => eachLevel?.value === values?.levelOfEducation)?.[0]?.label,
                    "subjectName": levelOfEducation?.filter(eachLevel => eachLevel?.value === values?.levelOfEducation)?.[0]?.label,
                    "universityName": values?.universityName,
                    "departmentName": values?.subject,
            ...
            <div className='mx-[2%] sm:mx-[10%] mt-[13vh] mb-6 border-2 border-[#e5e7eb] p-5 rounded shadow-[0px_0px_9px_0px]'>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', marginTop: '20px' }}>
                    ...
                    <div className={`flex flex-col sm:flex-row items-start sm:items-center p-2.5 rounded-sm ${(touched?.subject && errors?.subject) ? 'bg-[#ff000014]' : 'bg-[#77889914]'}`}>
                        <div style={{ display: 'flex', fontSize: '14px', fontWeight: '600', marginBottom: "20px" }}
                            className='required w-full sm:w-[50%] text-left'>
                            15. Name of Subject/Diploma/Group
                        </div>
                    ...
                    <div className={`flex flex-col sm:flex-row items-start sm:items-center p-2.5 rounded-sm ${(touched?.freelancingProfile && errors?.freelancingProfile) ? 'bg-[#ff000014]' : 'bg-[#77889914]'}`}>
                        <div style={{ display: 'flex', fontSize: '14px', fontWeight: '600', marginBottom: "20px" }}
                            className='w-full sm:w-[50%] text-left'>
                            19.  Link of Freelancing Profile
                        </div>
...
export default RegistrationFormForFoundational